                ...
                <Fieldset class="flex-auto">
                    ...
                    <div class="surface-section">
                        <ul class="list-none p-0 m-0">
                            ...
                            <li class="row">
                                <div class="key1">Fonction dans l'entreprise</div>
                                <span class="p-input-icon-left">
                                    <i class="pi pi-sitemap" />
                                    <InputText placeholder="fonction" v-model="position"/>
                                </span>
                            </li>
                            <li class="row">
                            ...
                            <li class="row">
                                ...
                                <span class="p-input-icon-left">
                                    ...
                                    <InputMask placeholder="Téléphone" v-model="mobilePhone" mask="+99999999999" />
                                </span>
                            </li>
                    ...
                    <div class="surface-section">
                        <ul class="list-none p-0 m-0">
                            ...
                            <div class="key2">Entreprise</div>
                                <div class="value">{{ selectedCompany.nom}}</div>
                        </li>
                        <li class="row">
                            <div class="key2">Statut juridique</div>
                                <div class="value">{{ selectedCompany.entiteJuridique }}</div>
                        </li>
                            <li class="row">
                            ...
                            <li class="row">
                                <div class="key1">Complément d'adresse</div>
                                    <div class="value">  {{ adresse.complementAdresse }}
                                </div>
                            </li>
                            <li class="row">
