...
export const isValidMember = (birthDate: any, birthPlace: any, nationality: any, promotion: any, contributionDate: any, department: any, membershipNumber: any) => {
    ...
    if (promotion < '1920' || promotion > '9999') return { valid: 0, message: 'Your promotion must be between 1920 and 9999' }
    if (!(contributionDate instanceof Date)) return { valid: 0, message: 'Your contribution date is not correcly formatted.' }
