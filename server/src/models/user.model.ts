...
import { Table, Column, Model, DataType, CreatedAt, UpdatedAt, ForeignKey, BelongsTo, IsEmail, IsDate, NotEmpty, PrimaryKey, HasMany, HasOne } from 'sequelize-typescript'
